...
client.on("message", message => {
    if (message.content === (prefix + "help")) {
     const embed = new Discord.RichEmbed() 
         ...
         .setDescription(`**
         ------------------------------
         #send : برودكاست لجميع اعضاء السيرفر بايمبد
         #send2 : برودكاست لجميع اعضاء السيرفر بدون ايمبد
         #send3 : برودكاست للاعضاء  الاونلاين فقط
         ------------------------------
         _id : عرض ملفك الشخصي
...
client.login('NTg1NzEwODE4NDUzMzU2NTQ1.XPdb4Q.JaoBeHDnyU34UpF7pL2yknZnlbM');